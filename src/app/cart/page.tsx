  ...
  return (
    <div className="container">
        ...
        <table className="min-w-full border text-sm">
          ...
          <tbody>
            ...
            <tr className="border-t">
              <td className="p-2" colSpan={2}>VALES</td>
      ...
      <div className="mt-6 flex justify-between">
        <Link href="/" className="bg-red-500 text-white px-6 py-2 rounded">SEGUIR COMPRANDO</Link>
        <Link href="/checkout" className="bg-green-600 text-white px-6 py-2 rounded">INICIAR COMPRA</Link>
      </div>
    </div>
  );
}
